<script lang="ts">
  ...
  onMount(() => {
    ...
    document.addEventListener('click', (e: MouseEvent) => {
      ...
      if (isDropdownOpen && themeControls && !e.composedPath().includes(themeControls)) {
  ...
  <div class="flex items-center gap-2">
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--text-color)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M20.71 4.04a1 1 0 0 1 .02 1.39l-9.6 9.6c-.1.1-.21.18-.33.24l-3.76 1.25a1 1 0 0 1-1.27-1.27l1.25-3.76c.06-.12.14-.23.24-.33l9.6-9.6a1 1 0 0 1 1.41.02z"></path>
    ...
    >
      ...
      {:else}
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--text-color)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-moon">
