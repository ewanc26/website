...
<div class="flex mb-6 border-b border-[var(--button-bg)] overflow-x-auto relative tabs-container">
  <div class="tab-indicator-container absolute bottom-0 left-0 h-0.5 w-full">
    <div 
      ...
      style="left: {groupedByYear.findIndex(g => g.year === activeYear) * 100}px; width: 100px;"
    ></div>
  </div>
